  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "src/components/generic/AppContext.tsx",
        "src/components/issue-preview/utils/issuePreviewUtils.ts",
        "src/components/nav-bar/listUtils.ts",
        "src/components/generic/PaginatedQuery.tsx",
        "src/components/generic/withContext.tsx",
        ...
        "src/components/restricted/editor/Editor.tsx",
        "src/components/restricted/editor/PublisherEditor.tsx",
        "src/components/restricted/editor/SeriesEditor.tsx",
        "src/components/restricted/editor/IssueEditor.tsx",
        "src/components/restricted/editor/IssueEditorSections.tsx",
        "src/components/restricted/editor/issue-editor/cache.ts",
        "src/components/restricted/editor/issue-editor/defaultValues.ts",
        "src/components/restricted/editor/issue-editor/payload.ts",
        "src/components/restricted/editor/issue-sections/helpers.ts",
        "src/app/AppRoutes.tsx",
        "src/app/authEvents.ts",
        "src/app/useResponsive.ts",
