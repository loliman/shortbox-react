...
function Privacy(props) {
    return (
        <Layout>
            ...
            <CardContent className="cardContent">
                <Typography>
                    <p>Diese Datenschutzerklärung klärt Sie
                    ...
                    <h3
                        id="dsg-general-datasubjects">Kategorien betroffener Personen</h3>
                    <p>Besucher und Nutzer des
                        Onlineangebotes (Nachfolgend bezeichnen wir die betroffenen Personen zusammenfassend auch als
                        „Nutzer“).<br/>
                    </p>
                    <h3 id="dsg-general-purpose">Zweck der Verarbeitung</h3>
                    <p>- Zurverfügungstellung des
                    ...
                    <h3 id="dsg-general-terms">Verwendete
                        Begrifflichkeiten
                    </h3>
                    ...
                    <p>Nach Maßgabe des Art. 13 DSGVO
                    ...
                    <p>Wir treffen nach Maßgabe der
                    ...
                    <h3 id="dsg-general-coprocessing">Zusammenarbeit mit Auftragsverarbeitern, gemeinsam
                    ...
                    <h3
                        id="dsg-general-changes">Änderungen und Aktualisierungen der Datenschutzerklärung</h3>
                    <p>Wir bitten
   ...
   Hierbei verarbeiten wir, bzw. unser Hostinganbieter Bestandsdaten, Kontaktdaten, Inhaltsdaten, Vertragsdaten, Nutzungsdaten, Meta- und Kommunikationsdaten von Kunden, Interessenten und Besuchern dieses Onlineangebotes auf Grundlage unserer berechtigten Interessen an einer effizienten und sicheren Zurverfügungstellung dieses Onlineangebotes gem. Art. 6 Abs. 1 lit. f DSGVO i.V.m. Art. 28 DSGVO (Abschluss Auftragsverarbeitungsvertrag).</span>
                    ...
                    <p></p>
                    <h3 id="dsg-thirdparty-marvelwikia">Marvel Database</h3>
                    <p></p>
                    <p><span>Wir binden Bilder des Anbieters Fandom, 149 New Montgomery Street, 3rd Floor, San Francisco, CA 94105, ein.
                        Nach Angaben von Fandom werden die Daten der Nutzer allein zu Zwecken der Darstellung der Bilder im Browser der Nutzer verwendet. Die Einbindung erfolgt auf Grundlage unserer berechtigten Interessen an einer korrekten und vollständigen Darstellung von US Covern, sowie Berücksichtigung möglicher lizenzrechtlicher Restriktionen für deren Einbindung. Datenschutzerklärung: <a
                            target="_blank" rel="noopener noreferrer nofollow"
                            href="https://www.fandom.com/privacy-policy">https://www.fandom.com/privacy-policy</a>.</span>
                    </p>
                    <br/><a href="https://datenschutz-generator.de" rel="noopener noreferrer nofollow" target="_blank">Erstellt
