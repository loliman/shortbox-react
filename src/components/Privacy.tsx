    ...
    <Layout>
      ...
      <CardContent className="cardContent">
        ...
        <Typography>
          ...
          bestimmt sich nach den Vorgaben des Art. 9 Abs. 2 DSGVO. <br />
        </Typography>
        ...
        <Typography>
          ...
          gespeichert bleiben. So kann z.B. der Login-Status gespeichert werden, wenn die Nutzer
          ...
          Rahmen einer Cookie-Einwilligung), ist die Rechtsgrundlage dieser Verarbeitung Art. 6 Abs.
          1 lit. a. DSGVO. Ansonsten werden die personenbezogenen Cookies der Nutzer entsprechend
          den nachfolgenden Erläuterungen im Rahmen dieser Datenschutzerklärung auf Grundlage
          ...
          oder sofern der Einsatz von Cookies zur Erbringung unserer vertragsbezogenen Leistungen
          erforderlich ist, gem. Art. 6 Abs. 1 lit. b. DSGVO, bzw. sofern der Einsatz von Cookies
          für die Wahrnehmung einer Aufgabe, die im öffentlichen Interesse liegt erforderlich ist
          oder in Ausübung öffentlicher Gewalt erfolgt, gem. Art. 6 Abs. 1 lit. e. DSGVO,
          verarbeitet.
          <br />
          <br />
        ...
        <Typography>
          ...
          die Datenschutzbestimmungen des „EU-US Privacy Shield“-Abkommens.
          <br />
